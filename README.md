...
Diagnose stationarity and model structure
...
Code
nba-lakers-net-rating-forecast/
│
├── data/
│   ├── raw/                     # Original Excel game logs (not included)
│   └── processed/               # Cleaned or transformed datasets
│
├── R/
│   ├── main.R                   # Full analysis pipeline
│   ├── modeling.R               # ARIMA modeling + diagnostics
│   ├── forecasting.R            # Forecast generation + plots
│   └── utils.R                  # Helper functions
│
├── figs/                        # Plots generated by the analysis
│
├── report/
│   └── lakers_net_rating_report.pdf   # Final PDF report
│
├── README.md                    # Project documentation
└── .gitignore
📊 Data Source
Game logs were obtained from Basketball Reference, which provides detailed box score and advanced statistics for every NBA game.
